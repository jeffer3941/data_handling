...
try {
    ...
    $csv_questions_download->insertOne(['identificador','enunciated','link_do_video','comment','alternativa_a', 'alternativa_b','alternativa_c','alternativa_d','alternativa_e','correct']);
